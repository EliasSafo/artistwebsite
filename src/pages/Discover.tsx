...
export const Discover: React.FC = () => {
  useDocumentTitle('Discover - Malaïka');
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  {latestRelease.streamingLinks?.spotify && (
                    ...
                    >
                      <Button variant="primary">
                        <span className="inline-block align-middle mr-2"><Music className="w-5 h-5" /></span>
                        Spotify
                      </Button>
                    </a>
                  )}
                  {latestRelease.streamingLinks?.apple && (
                    ...
                    >
                      <Button variant="secondary">
                        <span className="inline-block align-middle mr-2"><Apple className="w-5 h-5" /></span>
                        Apple Music
                      </Button>
                    </a>
                  )}
                  {latestRelease.streamingLinks?.youtube && (
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      {/* Add YouTube button/icon here if needed */}
                    </a>
                  )}
                </div>
              </div>
